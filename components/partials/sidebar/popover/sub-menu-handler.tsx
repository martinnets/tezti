    ...
    <>
      {collapsed ? (
        ...
        <div
          ...
          className={cn(
            "flex  text-default-700 font-medium text-sm capitalize px-[10px] py-3 rounded cursor-pointer transition-all duration-100 hover:bg-success hover:text-success-foreground group",
            {
